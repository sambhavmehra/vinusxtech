    ...
    try {
      ...
      `,
        ...
        if (!brevoResponse.ok) {
            ...
            return NextResponse.json({ error: 'Failed to send email', details: errorData }, { status: brevoResponse.status });
        }
        ...
        try {
            ...
            console.error('[Contact] Failed to send auto-reply:', autoReplyErr);
        }
