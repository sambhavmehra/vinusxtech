...
import { Mail, Phone, MapPin, Github, Linkedin, Twitter, ArrowUpRight, ShieldCheck } from 'lucide-react';
...
export default function Footer() {
  ...
  return (<footer className="relative bg-[#050508] border-t border-white/[0.05] overflow-hidden mt-10">
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-12 relative z-10">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-6">
        ...
        <div className="md:col-span-2 lg:col-span-4 lg:pr-4">
          <Link href="/" className="inline-flex items-center gap-4 mb-4 relative group">
            ...
            <Image src="/logo.png" alt="VinUSXtech Logo" width={400} height={160} className="object-contain h-28 md:h-[120px] w-auto relative z-10 drop-shadow-2xl" />
            <span className="relative z-10 text-xl md:text-2xl font-bold tracking-tight text-white whitespace-nowrap">
    ...
    <div className="absolute bottom-0 left-0 w-full overflow-hidden flex justify-center items-end pointer-events-none select-none z-0 translate-y-[10%]">
      <h1 className="text-[13.5vw] font-black leading-none tracking-tighter text-white opacity-5 whitespace-nowrap">
        VINUSXTECH
      </h1>
    </div>
  </footer>);
