    ...
    <div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        {[1, 2, 3].map((ring) => (
          <motion.div
            key={ring}
            className="absolute rounded-full border border-[#00ff88]"
            style={{ opacity: 0.1 / ring }}
            animate={{
        ...
        <motion.div
          ...
          style={{ background: 'radial-gradient(circle, #00ff8830, transparent)' }}
