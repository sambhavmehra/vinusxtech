...
import { Code, Brain, Shield, Lock, Database, Cloud, Smartphone, Globe, CheckCircle2, Hexagon } from 'lucide-react';
...
export default function ServicesPage() {
  ...
  return (<div ref={containerRef} className="relative min-h-screen overflow-hidden text-white pt-24 bg-[#050508]">
    ...
    <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8">
      ...
      <section className="py-24 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {developmentServices.map((service, idx) => (<RevealSection key={service.title} delay={idx * 0.1}>
      ...
      <section className="py-24 max-w-7xl mx-auto relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
          {aiServices.map((service, idx) => (<RevealSection key={service.title} delay={idx * 0.1}>
            <motion.div whileHover={{ scale: 1.02 }} className="glass-card rounded-[2rem] p-10 h-full relative overflow-hidden group border border-[#a855f7]/20">
            ...
            <div className="glass-card rounded-[2.5rem] p-10 md:p-12 relative overflow-hidden group h-full border-t border-[#00ff88]/30">
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-4">
                  {vaptFeatures.map((feature, index) => (<motion.div key={feature} initial={{ opacity: 0, x: -10 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.05 }} className="flex items-center gap-4 bg-white/[0.02] border border-white/5 rounded-xl p-3 hover:bg-white/[0.05] transition-colors">
          ...
          <RevealSection delay={0.2}>
            <div className="glass-card rounded-[2.5rem] p-10 md:p-12 relative overflow-hidden group h-full border-t border-[#00d4ff]/30">
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-4">
                  {socFeatures.map((feature, index) => (<motion.div key={feature} initial={{ opacity: 0, x: 10 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.05 }} className="flex items-center gap-4 bg-white/[0.02] border border-white/5 rounded-xl p-3 hover:bg-white/[0.05] transition-colors">
