  ...
  return (
    <div ref={containerRef} className="relative min-h-screen overflow-hidden text-white pt-24">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
        <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] rounded-full bg-[#ffb347]/10 blur-[150px]" />
        <div className="absolute top-[20%] right-[-10%] w-[40%] h-[60%] rounded-full bg-[#a855f7]/10 blur-[150px]" />
        <div className="absolute bottom-[-10%] left-[20%] w-[60%] h-[40%] rounded-full bg-[#ff00ff]/10 blur-[150px]" />
      </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 bg-white/[0.04] border border-white/[0.08] rounded-xl focus:outline-none focus:border-[#ffb347]/60 focus:bg-[#ffb347]/[0.03] transition-all duration-300 text-white placeholder-gray-600 text-sm"
                        />
                      </div>
                      <div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        required
                        rows={6}
                        placeholder="VinusXTech completely transformed our infrastructure..."
                        className="w-full px-4 py-3 bg-white/[0.04] border border-white/[0.08] rounded-xl focus:outline-none focus:border-[#ffb347]/60 focus:bg-[#ffb347]/[0.03] transition-all duration-300 text-white placeholder-gray-600 resize-none text-sm"
                      />
                    </div>
                    ...
                    <motion.button
                      type="submit"
                      disabled={loading}
                      whileHover={!loading ? { scale: 1.02, boxShadow: '0 0 40px rgba(255,179,71,0.3)' } : {}}
                      whileTap={!loading ? { scale: 0.98 } : {}}
                      className={`w-full px-8 py-4 rounded-full font-bold text-base flex items-center justify-center gap-3 transition-all duration-300 ${
                        loading ? 'bg-white/10 text-gray-400 cursor-not-allowed' : 'bg-gradient-to-r from-[#ffb347] to-[#ff00ff] text-black'
                      }`}
                    >
                      {loading ? (
                        <>
