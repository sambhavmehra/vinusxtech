      ...
      {isOpen && (<motion.div initial={{ opacity: 0, y: 20, scale: 0.9 }} animate={{ opacity: 1, y: 0, scale: 1 }} exit={{ opacity: 0, y: 20, scale: 0.9 }} className="fixed bottom-28 md:bottom-28 right-4 md:right-6 w-[calc(100vw-2rem)] sm:w-[400px] h-[75vh] sm:h-[650px] shadow-2xl flex flex-col overflow-hidden z-50 origin-bottom-right" style={{
        ...
        <div className="shrink-0 flex items-center justify-between p-5 border-b border-white/5 bg-gradient-to-r from-[#00ff88]/10 via-[#00d4ff]/5 to-transparent relative overflow-hidden">
          ...
          <div className="flex items-center space-x-4 relative z-10">
            ...
            <div>
              <div className="font-extrabold text-white text-base tracking-wide bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-400">NexBot AI</div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={() => setIsOpen(false)} aria-label="Close Chatbot" className="relative z-10 w-8 h-8 flex items-center justify-center rounded-full bg-white/5 hover:bg-white/10 text-gray-400 hover:text-white transition-all duration-300">
              <X className="w-4 h-4" />
            </button>
          </div>
        </div>
              ...
              {leadSuccess ? (
                ...
                <form onSubmit={handleLeadSubmit} className="w-full max-w-sm space-y-4">
                  <div className="text-center mb-4">
                    ...
                    <div className="text-lg font-bold text-white">{userMessageCount >= 7 ? 'Continue Chatting' : 'Start Your Project'}</div>
                    <p className="text-gray-400 text-xs mt-1">{userMessageCount >= 7 ? 'Please share your details to continue' : 'Share your details and we\'ll get back to you'}</p>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full text-center text-gray-400 text-xs hover:text-gray-300 transition-colors"
                  >
        ...
        <div className="shrink-0 p-4 border-t border-white/[0.08] bg-black/60 backdrop-blur-md flex flex-col gap-3">
          ...
          <div className="text-center pb-1">
            <span className="text-[9px] font-mono tracking-widest text-gray-400 uppercase">Vinusxtech</span>
          </div>
        </div>
      </motion.div>)}
    </AnimatePresence>
